...
DATASETS = {
    ...
    'siim_val-split_stage1': {
        IM_DIR:
            _DATA_DIR + '/siim-kaggle/jpg-images-train-stage1/',
        ANN_FN:
            _DATA_DIR + '/siim-kaggle/coco_annotations/val-stg1-split.json',
    },

    'siim_val-split_stage1-dbg': {
        IM_DIR:
            _DATA_DIR + '/siim-kaggle/jpg-images-train-stage1/',
        ANN_FN:
            _DATA_DIR + '/siim-kaggle/coco_annotations/dbg-val.json',
    },

    'siim_test-stg1': {
        IM_DIR:
            _DATA_DIR + '/siim-kaggle/jpg-images-test-stage1/',
        ANN_FN:
            _DATA_DIR + '/siim-kaggle/coco_annotations/test-stg1.json',
        # IM_PREFIX: 'siim_test-stg1_'
    },
}
