...
from panet.model.roi_pooling.functions.roi_pool import RoIPoolFunction
from panet.model.roi_crop.functions.roi_crop import RoICropFunction
from panet.modeling.roi_xfrom.roi_align.functions.roi_align import RoIAlignFunction
import panet.modeling.rpn_heads as rpn_heads
import panet.modeling.fast_rcnn_heads as fast_rcnn_heads
import panet.modeling.mask_rcnn_heads as mask_rcnn_heads
import panet.modeling.keypoint_rcnn_heads as keypoint_rcnn_heads
import panet.utils.blob as blob_utils
import panet.utils.net as net_utils
import panet.utils.resnet_weights_helper as resnet_utils
...
def get_func(func_name):
    ...
    try:
        ...
        module_name = 'panet.modeling.' + '.'.join(parts[:-1])
